...
| # | 제목 | 우선순위 | 분류 | 상태 | 상세 |
| --- | --- | --- | --- | --- | --- |
| 1 | JSDoc 타입 어노테이션 | 🔴 높음 | DX / 도구 | 3단계 완료 | [001-jsdoc-annotations.md](001-jsdoc-annotations.md) |
| 2 | 모듈 분리 | 🟡 보통 | 아키텍처 | 계획 | [002-module-splitting.md](002-module-splitting.md) |
| 3 | Alienese 인라인 문서화 | 🟡 보통 | DX | 계획 | [003-alienese-inline-docs.md](003-alienese-inline-docs.md) |
